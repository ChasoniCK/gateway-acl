...
проекта (установщик предложит его добавить — но только когда вы за клавиатурой, а
не при обновлении с `--yes`), в остальных случаях собирается руками. Если его
поставить не удалось, установщик пишет, какая это система, — этого достаточно,
